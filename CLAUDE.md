...
The reference pages in `docs/design/` document how inkstand behaves today. Update them in
the same change as the code. Documentation reflects current behavior.
...
examples/     demo.tsx, the recipes composed from the parts.
docs/design/  the component reference.
```
